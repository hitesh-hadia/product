            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?php if($customer->status != 'active'){ ?>
                        <?= $this->Html->link(__('Active'), ['action' => 'active', $customer->id]) ?> |
                    <?php } ?>
                    <?php if($customer->status != 'pending'){ ?>
                        <?= $this->Html->link(__('Pending'), ['action' => 'pending', $customer->id]) ?> |
                    <?php } ?>
                    <?php if($customer->status != 'blocked'){ ?>
                        <?= $this->Html->link(__('Block'), ['action' => 'blocked', $customer->id]) ?> |
                    <?php } ?>
