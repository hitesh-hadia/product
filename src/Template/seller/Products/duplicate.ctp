...
<div class="products form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('image[]', ['type' => 'file', 'multiple' => 'true','required' => 'true', 'label' => 'image']);
            echo $this->Form->control('description');
            // $images = array();
            // foreach ($product->product_images as $productImage) { 
            //         $images[] = $productImage['image'];
            //     }
            // echo $this->Form->input('oldimg', ['options' => $images,'type' => 'select','multiple' => 'true','empty' => true,'label' => 'old image']);
        ?>
    </fieldset>
