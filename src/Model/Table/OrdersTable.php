...
class OrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->maxLength('transaction_id', 512)
            ->requirePresence('transaction_id', 'create')
            ->notEmptyString('transaction_id');

        $validator
            ->scalar('order_id')
            ->maxLength('order_id', 512)
            ->requirePresence('order_id', 'create')
            ->notEmptyString('order_id');

        $validator
            ->scalar('razorpay_signature')
            ->maxLength('razorpay_signature', 512)
            ->requirePresence('razorpay_signature', 'create')
            ->notEmptyString('razorpay_signature');
